 ...
 * ----Third SDK            : CZLK_PREDEFINED_TASK_THIRD_SDK_START
 *
...
#pragma mark - Timeline(CZAppLaunchKit): Third SDK Phase
#define CZLK_PREDEFINED_TASK_THIRD_SDK_START() \
CZLK_PHASE_POINT_TASK(CZLK_THIRD_SDK_START, "CZLK_HOME_PAGE_DID_RENDER_START", "CZLK_HOME_PAGE_DID_RENDER_END", "CZAppLaunchKit phase [Third SDK] start")

#define CZLK_PREDEFINED_TASK_THIRD_SDK_END() \
CZLK_PHASE_POINT_TASK(CZLK_THIRD_SDK_END, "CZLK_THIRD_SDK_START", "CZLK_HOME_PAGE_DID_RENDER_END", "CZAppLaunchKit phase [Third SDK] end")
...
#define CZLK_INVOKE_HOME_PAGE_DID_RENDER_START_TO_END() \
[CZLKManager executeTasksFrom:@"CZLK_HOME_PAGE_DID_RENDER_START" to:@"CZLK_HOME_PAGE_DID_RENDER_END"]
